 ...
 * @brief Board name
 */
#define ESP_PANEL_BOARD_NAME                "Elecrow:CROWPANEL_7_0"
 ...
 */
#define ESP_PANEL_BOARD_LCD_CONTROLLER      EK9716B // Fitipower EK9716B
 ...
 */
    ...
    #define ESP_PANEL_BOARD_LCD_RGB_VPW             (31)
    #define ESP_PANEL_BOARD_LCD_RGB_VBP             (13)
    #define ESP_PANEL_BOARD_LCD_RGB_VFP             (1)
    ...
    #define ESP_PANEL_BOARD_LCD_RGB_IO_VSYNC        (40)
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DE           (41)    // -1 if not used
    #define ESP_PANEL_BOARD_LCD_RGB_IO_PCLK         (0)
    ...
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA1        (7)     //        |      D1      |   B1   |  B2    |   B4   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA2        (6)     //        |      D2      |   B2   |  B3    |   B5   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA3        (5)     //        |      D3      |   B3   |  B4    |   B6   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA4        (4)     //        |      D4      |   B4   |  B5    |   B7   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA5        (9)     //        |      D5      |   G0   |  G0    |   G0-2 |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA6        (46)    //        |      D6      |   G1   |  G1    |   G3   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA7        (3)     //        |      D7      |   G2   |  G2    |   G4   |
#if ESP_PANEL_BOARD_LCD_RGB_DATA_WIDTH > 8                  //        ┗--------------┫--------|--------|--------|
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA8        (8)     //                       |   G3   |  G3    |   G5   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA9        (16)    //                       |   G4   |  G4    |   G6   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA10       (1)     //                       |   G5   |  G5    |   G7   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA11       (14)    //                       |   R0   |  R0-1  |   R0-3 |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA12       (21)    //                       |   R1   |  R2    |   R4   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA13       (47)    //                       |   R2   |  R3    |   R5   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA14       (48)    //                       |   R3   |  R4    |   R6   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA15       (45)    //                       |   R4   |  R5    |   R7   |
                                                            //                       ┗--------┻--------┻--------┛
...
#define ESP_PANEL_BOARD_TOUCH_INT_IO            (38)    // Interrupt pin, -1 if not used
...
#define ESP_PANEL_BOARD_EXPANDER_I2C_IO_SCL         (20)
#define ESP_PANEL_BOARD_EXPANDER_I2C_IO_SDA         (19)
